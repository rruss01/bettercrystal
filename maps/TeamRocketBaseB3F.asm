	...
	const TEAMROCKETBASEB3F_HONCHKROW
...
LanceGetPasswordScript:
	...
	pause 5
	turnobject TEAMROCKETBASEB3F_HONCHKROW, RIGHT
	pause 20
...
TeamRocketBaseB3F_MapEvents:
	...
	object_event  7,  2, SPRITE_HONCHKROW, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, RocketBaseMurkrow, EVENT_TEAM_ROCKET_BASE_POPULATION
