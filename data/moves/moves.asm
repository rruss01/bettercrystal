...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move PIN_MISSILE,  EFFECT_MULTI_HIT,          19, BUG,           95, 20,   0
	...
	move ANCIENTPOWER, EFFECT_ALL_UP_HIT,         60, ROCK,         100, 15,  20
	...
	move DOUBLE_HIT,   EFFECT_DOUBLE_HIT,		  45, NORMAL,        95, 15,   0
