...
WhitneyGroup:
	...
	db 18, TEDDIURSA,  SCRATCH, LEER, LICK, FAINT_ATTACK
...
BugsyGroup:
	...
	db 14, SPINARAK,   TACKLE, STRING_SHOT, POISON_STING, NO_MOVE
	db 14, LEDIAN,     DIZZY_PUNCH, STRING_SHOT, THUNDERPUNCH, NO_MOVE
	db 16, SCYTHER,    QUICK_ATTACK, LEER, FURY_CUTTER, SWORDS_DANCE
	db -1 ; end
...
MortyGroup:
	...
	db 23, STANTLER,   PROTECT, STOMP, HYPNOSIS, THIEF
	db -1 ; end

PryceGroup:
	; PRYCE (1) if badge 5
	db "PRYCE@", TRAINERTYPE_MOVES
	db 31, DEWGONG,    SURF, RAIN_DANCE, AURORA_BEAM, REST
	db 32, SNEASEL,    FAINT_ATTACK, METAL_CLAW, REFLECT, ICY_WIND
	db 31, JYNX,   	   ICE_PUNCH, PSYCHIC_M, RAIN_DANCE, LOVELY_KISS
	db 33, PILOSWINE,  HEADBUTT, EARTHQUAKE, ROCK_SMASH, BLIZZARD
	db -1 ; end
	; PRYCE (2) if badge 6
	db "PRYCE@", TRAINERTYPE_MOVES
	db 33, CLOYSTER,   SURF, SPIKES, AURORA_BEAM, RAIN_DANCE
	db 34, SNEASEL,    FAINT_ATTACK, METAL_CLAW, REFLECT, ICE_PUNCH
	db 34, DEWGONG,    SURF, SNORE, AURORA_BEAM, REST
	db 33, JYNX,   	   ICE_PUNCH, PSYCHIC_M, RAIN_DANCE, LOVELY_KISS
	db 35, PILOSWINE,  HEADBUTT, EARTHQUAKE, ROCK_SMASH, BLIZZARD
	db -1 ; end
	; PRYCE (3) if badge 7
	db "PRYCE@", TRAINERTYPE_MOVES
	db 37, CLOYSTER,   SURF, SPIKES, AURORA_BEAM, RAIN_DANCE
	db 37, SNEASEL,    FAINT_ATTACK, METAL_CLAW, REFLECT, ICE_PUNCH
	db 37, DEWGONG,    SURF, SNORE, AURORA_BEAM, REST
	db 37, JYNX,   	   ICE_PUNCH, PSYCHIC_M, RAIN_DANCE, LOVELY_KISS
	db 38, PILOSWINE,  HEADBUTT, EARTHQUAKE, ROCK_SMASH, BLIZZARD
	db -1 ; end

JasmineGroup:
	; JASMINE (1) if badge 5 or 6
	db "JASMINE@", TRAINERTYPE_MOVES
	db 35, SKARMORY,   SPIKES, DRILL_PECK, SWAGGER, STEEL_WING
	db 35, MAGNETON,   THUNDERBOLT, TRI_ATTACK, RAIN_DANCE, THUNDER
	db 35, CORSOLA,    RAIN_DANCE, SURF, RECOVER, ANCIENTPOWER
	db 36, SCIZOR,     TWINEEDLE, METAL_CLAW, AGILITY, SWORDS_DANCE
	db 36, STEELIX,    CRUNCH, EARTHQUAKE, ROCK_SLIDE, IRON_TAIL
	db -1 ; end
	; JASMINE (2) if badge 7
	db "JASMINE@", TRAINERTYPE_MOVES
	db 37, SKARMORY,   SPIKES, DRILL_PECK, SWAGGER, STEEL_WING
	db 37, MAGNETON,   THUNDERBOLT, TRI_ATTACK, RAIN_DANCE, THUNDER
	db 37, CORSOLA,    RAIN_DANCE, SURF, RECOVER, ANCIENTPOWER
	db 38, SCIZOR,     TWINEEDLE, METAL_CLAW, AGILITY, SWORDS_DANCE
	db 38, STEELIX,    CRUNCH, EARTHQUAKE, ROCK_SLIDE, IRON_TAIL
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 30, HITMONTOP,  TRIPLE_KICK, ROLLING_KICK, DIG, PURSUIT
	db 30, SUDOWOODO,  ROCK_SLIDE, THUNDERPUNCH, LOW_KICK, FAINT_ATTACK
	db 29, PRIMEAPE,   KARATE_CHOP, ICE_PUNCH, RAGE, NO_MOVE
	db 31, POLIWRATH,  HYPNOSIS, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end
	; CHUCK (2)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 35, HITMONTOP,  TRIPLE_KICK, ROLLING_KICK, DIG, PURSUIT
	db 35, SUDOWOODO,  ROCK_SLIDE, THUNDERPUNCH, LOW_KICK, FAINT_ATTACK
	db 35, PINSIR,     SUBMISSION, TWINEEDLE, STRENGTH, SWORDS_DANCE
	db 34, PRIMEAPE,   KARATE_CHOP, ROCK_SLIDE, RAGE, DYNAMICPUNCH
	db 36, POLIWRATH,  ICE_PUNCH, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end
	; CHUCK (3)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 37, HITMONTOP,  TRIPLE_KICK, ROLLING_KICK, DIG, PURSUIT
	db 37, SUDOWOODO,  ROCK_SLIDE, THUNDERPUNCH, LOW_KICK, FAINT_ATTACK
	db 37, PINSIR,     SUBMISSION, TWINEEDLE, STRENGTH, SWORDS_DANCE
	db 37, PRIMEAPE,   KARATE_CHOP, ROCK_SLIDE, RAGE, NO_MOVE
	db 38, POLIWRATH,  ICE_PUNCH, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end
...
ClairGroup:
	...
	db 43, GYARADOS,   BITE, WATERFALL, FLY, TWISTER
	db 43, LAPRAS,     SURF, ICE_BEAM, BODY_SLAM, REST
...
BrunoGroup:
	...
	db 53, HITMONTOP,  TRIPLE_KICK, QUICK_ATTACK, DIG, DETECT
	db 52, HITMONLEE,  REVERSAL, DOUBLE_KICK, HI_JUMP_KICK, MEDITATE
	db 53, HITMONCHAN, THUNDERPUNCH, ICE_PUNCH, PURSUIT, MACH_PUNCH
	db 53, STEELIX,    CRUNCH, EARTHQUAKE, ROCK_SLIDE, IRON_TAIL
	db 54, AMBIPOM,    DOUBLE_HIT, FIRE_PUNCH, THUNDERPUNCH, SUBMISSION
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_MOVES
	db 54, UMBREON,    MOONLIGHT, DOUBLE_TEAM, FAINT_ATTACK, BATON_PASS
	db 53, MISMAGIUS,  STUN_SPORE, ACID, MOONLIGHT, PETAL_DANCE
	db 53, GENGAR,     SHADOW_BALL, HYPNOSIS, DREAM_EATER, CONFUSE_RAY
	db 53, MURKROW,    DRILL_PECK, STEEL_WING, HAZE, FAINT_ATTACK
	db 55, HOUNDOOM,   REVERSAL, IRON_TAIL, FLAMETHROWER, CRUNCH
	db -1 ; end
...
KogaGroup:
	...
	db 51, QWILFISH,   PROTECT, SURF, SLUDGE_BOMB, TOXIC
	db 51, VENOMOTH,   LEECH_LIFE, PSYCHIC_M, SLUDGE_BOMB, SLEEP_POWDER
	db 52, CROBAT,     DOUBLE_TEAM, BITE, CONFUSE_RAY, TOXIC
	db -1 ; end
...
ChampionGroup:
	...
	db 47, ZAPDOS,     THUNDER_WAVE, TWISTER, THUNDER, DRILL_PECK
