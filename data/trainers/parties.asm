...
FalknerGroup:
	...
	db 10, NOCTOWL,    TACKLE, MUD_SLAP, GUST, PECK
	db -1 ; end
...
WhitneyGroup:
	...
	db 20, TEDDIURSA,  SCRATCH, LEER, LICK, FAINT_ATTACK
...
BugsyGroup:
	...
	db 14, SPINARAK, NO_ITEM,       TACKLE, STRING_SHOT, POISON_STING, PIN_MISSILE
	db 14, LEDIAN,   NO_ITEM,       DIZZY_PUNCH, STRING_SHOT, THUNDERPUNCH, NO_MOVE
	db 16, SCYTHER,  BERRY_JUICE,   QUICK_ATTACK, LEER, CUT, SWORDS_DANCE
	db -1 ; end
...
BrunoGroup:
	...
	db 54, AMBIPOM,   	BLACKBELT_I,    DOUBLE_HIT, FIRE_PUNCH, THUNDERPUNCH, SUBMISSION
	db -1 ; end
...
ScientistGroup:
	...
	db 40, PORYGON2,    CONVERSION, CONVERSION2, RECOVER, TRI_ATTACK
	db -1 ; end
...
BlaineGroup:
	; BLAINE (1)
	db "BLAINE@", TRAINERTYPE_ITEM_MOVES | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME
	db 66, RAPIDASH,   QUICK_CLAW,     DOUBLE_EDGE, SUNNY_DAY, FIRE_BLAST, SOLARBEAM, $CC, $CC, "@"
	db 65, MAGMAR,     GOLD_BERRY,     THUNDERPUNCH, FIRE_BLAST, PSYCHIC_M, CONFUSE_RAY, $CC, $CC, "@"
	db 66, HOUNDOOM,   MIRACLE_SEED,   FIRE_BLAST, SUNNY_DAY, SOLARBEAM, CRUNCH, $CC, $CC, "@"
	db 65, NINETALES,  LEFTOVERS,      FIRE_BLAST, SHADOW_BALL, SUNNY_DAY,  HYPNOSIS, $CC, $CC, "@"
	db 67, UNOWN, 	   SHARP_BEAK,     FIRE_BLAST, SKY_ATTACK, SOLARBEAM, SUNNY_DAY, $CC, $CC, "MOLTRES@"
	db 67, ARCANINE,   CHARCOAL,       CRUNCH, DRAGONBREATH, FIRE_BLAST, EXTREMESPEED, $CC, $CC, "@"
	db -1 ; end
...
BlueGroup:
	...
	db 69, ARTICUNO,  MIRACLEBERRY,  ICE_BEAM, SKY_ATTACK, REST, TOXIC ; TODO: CHANGE TO UNOWN
